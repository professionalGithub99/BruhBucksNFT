...
// File: src/contracts/SupremeNFT.sol

pragma solidity ^0.8.0;


contract BruhNFT is  Ownable,ERC721URIStorage{
  event TokenMinted(uint256 tokenId);
uint256 private tokenId=0;
uint256 private MAX_TOKENS=100;
uint256 private decimals=16;
uint256 private currentPrice=12*(10**uint256(decimals));
    constructor() ERC721("BruhNFT", "BruhNFT") {
    }
 ...
 function purchase(string memory _tokenURI) external payable returns(uint256){
   ...
   require(tokenId<MAX_TOKENS,"All NFTs have sold out");
