...
uint256 private decimals=17;
uint256 private currentPrice=1*(10**uint256(decimals));
 ...
 function purchase(string memory _tokenURI) external payable returns(uint256){
   require(msg.value== 3*(10**uint256(decimals)),"pay more money");
   require(tokenId<MAX_TOKENS,"All bricks have sold out");
   _mint(msg.sender,tokenId);
   _setTokenURI(tokenId, _tokenURI);
   tokenId++;
   currentPrice=currentPrice*tokenId;
